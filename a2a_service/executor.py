...
class NewsAgentExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        # Extract user_id and mode from task metadata
        ...
        # News agent currently doesn't use modes much, but we pass it for future-proofing
        mode = task_metadata.get("mode") or "news_analyst"
